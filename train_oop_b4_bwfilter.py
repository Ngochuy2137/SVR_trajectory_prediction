...
class SVRTrainer:
    ...
    def load_and_prepare_data(self, folder_dir, axis_idx, data_train_lim=None, data_test_lim=None):
        inputs_train = []
        labels_train = []
        inputs_test = []
        labels_test = []
        ...
        for d_train in data_train:
            ...
            for point in xya_traj_i:
                ...
                labels_train.append(point[6+axis_idx])
        ...
        for d_test in data_test:
            ...
            for point in xya_traj_i:
                ...
                labels_test.append(point[6+axis_idx])
    ...
    def train_axisxyz(self, data_dir, data_train_lim=None, data_test_lim=None):
        self.data_train, self.data_test = self.load_and_prepare_data(folder_dir=data_dir, axis_idx=axis_idx, data_train_lim=data_train_lim, data_test_lim=data_test_lim)
        # train x, y, z
        for axis_idx in range(self.dms_num):
            print('Traing AXIS IDX:', axis_idx)
            self.train_each_axis(axis_idx=axis_idx)
